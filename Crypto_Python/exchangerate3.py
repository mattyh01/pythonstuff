...
def excelWrite():
    ...
    #filename = input("Whats the file name? (Full Path):  ")

    try:
        wb = openpyxl.load_workbook('/home/matt/Dropbox/Crypto.xlsx')
        sheet = wb.get_sheet_by_name('Info')
    except:
        print("Unable to access file {} - does it exist?".format(filename))
        quit()
    ...
    try:
        wb.save("/home/matt/Dropbox/Crypto.xlsx")
